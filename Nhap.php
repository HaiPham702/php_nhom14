...
<head>
    ...
    if ($_SESSION['isLogin']) {
        $sql = "SELECT r.Title, r.Id, r.Content, r.IsAppect, r.CreateDate, r.ReceiptType, s.StockName, e.FullName FROM receipt r INNER JOIN stock s ON r.StockId = s.Id INNER JOIN employee e ON r.EmployeeId = e.Id WHERE r.EmployeeId = " . $_SESSION['userId'] . ";";
        echo $sql;
                                            ...
                                            <div class="footer">
                                                <div class="row">
                                                    <div class="col">
                                                        ...
                                                        <div class="btn btn-close" style="background: #ccc;
    border-radius: 6px;
    text-align: center; width: 100%;">Đóng</div>
                                                    </div>
                                                    <div class="col">

                                                        <input style="background: green;
    color: white;" class="btn btn-primar" type="submit" value="Lưu">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
